...
import { FixedCoordinatesContainerElementSettingsComponent } from "./FixedCoordinatesContainerElementSettingsComponent";
...
export function defaultFixedCoordinatesContainerElementSettings(): FixedCoordinatesContainerElementSettings {
  return {
    positions: {},
    rotation: 0,
...
export class FixedCoordinatesContainerElement extends Element<FixedCoordinatesContainerElementSettings> {
  markup(): ReactNode {
    if (!this.container) {
      return <></>;
    }
    return (
      <FixedCoordinatesContainerElementSettingsComponent
        data={this.data}
