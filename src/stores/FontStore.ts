...
export class FontStore {
  ...
  public getImportCss(name: string) {
    ...
    if (font?.type === "google") {
      return Promise.resolve(`@font-face {
              ...
              @font-face {
                ...
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${font.name}@latest/latin-ext-400-normal.woff) format('woff');
              ...
              @font-face {
                ...
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${font.name}@latest/cyrillic-ext-400-normal.woff) format('woff');
              ...
              @font-face {
                ...
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${font.name}@latest/symbols-400-normal.woff) format('woff');
              ...
              @font-face {
                ...
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${font.name}@latest/math-400-normal.woff) format('woff');
    ...
    if (font?.type === "personal") {
      if (font.sources && font.sources["truetype"]) {
        const source = font.sources["truetype"];
        return fetch(source, {
          headers: {
