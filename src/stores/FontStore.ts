    ...
    return font.then((it) => {
      if (it.type === "google") {
        return `@font-face {
                ...
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${it.name}@latest/latin-400-normal.woff2) format('woff2'), url(https://cdn.jsdelivr.net/fontsource/fonts/${it.name}@latest/latin-400-normal.woff) format('woff');
                unicode-range: U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD;
              }

              /* play-latin-ext-400-normal */
              @font-face {
                font-family: '${it.name}';
                font-style: normal;
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${it.name}@latest/latin-ext-400-normal.woff) format('woff');
              ...
              @font-face {
                ...
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${it.name}@latest/cyrillic-ext-400-normal.woff) format('woff');
                unicode-range: U+0460-052F,U+1C80-1C8A,U+20B4,U+2DE0-2DFF,U+A640-A69F,U+FE2E-FE2F;
              }

              /* ruslan-display-symbols-400-normal */
              @font-face {
                font-family: '${it.name}';
                font-style: normal;
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${it.name}@latest/symbols-400-normal.woff) format('woff');
              ...
              /* ruslan-display-math-400-normal */
              @font-face {
                font-family: '${it.name}';
                font-style: normal;
                font-display: auto;
                font-weight: 400;
                src: url(https://cdn.jsdelivr.net/fontsource/fonts/${it.name}@latest/math-400-normal.woff) format('woff');
      ...
      if (it.type === "personal") {
        if (it.sources && it.sources["truetype"]) {
          const source = it.sources["truetype"];
          return fetch(source, {
            headers: {
