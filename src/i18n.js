    ...
    resources: {
      en: {
        translation: {
          ...
          "widget-donaterslist-list-carousel-item-amount":"Amount of shown items",
          "widget-donaterslist-list-alignment":"Alignment",
          "widget-donaterslist-carousel-delay":"Delay between each auto scroll",
      ...
      ru: {
        translation: {
          ...
          "widget-donaterslist-list-enable-carousel":"Показывать по частям, каруселью",
          "widget-donaterslist-list-carousel-item-amount":"Одновременно отображаемое кол-во донатеров",
